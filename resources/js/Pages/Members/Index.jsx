                            ...
                            {members.data.map(member => (
                                <tr key={member.id} className="border-b dark:border-slate-700 last:border-0">
                                    ...
                                    <td className="py-3 text-right space-x-3 text-sm">
                                        <button onClick={() => { setEditingId(member.id); setData({name: member.name, email: member.email, phone: member.phone, is_active: member.is_active}); }} className="text-brand-600 hover:underline">Editar</button>
